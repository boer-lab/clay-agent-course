...
(function () {
  ...
  // Lesson 5 carries its own end-of-course survey block, rendered by build.py.
  // It used to be faked by rewriting the footer's report-a-problem link, which
  // pointed both asks at the same form; they are separate forms now.
  if (here === "5") {
    onReady(function () {
      var survey = document.querySelector(".feedback-survey");
      if (survey) survey.classList.add("feedback-final");
    });
  }
})();
